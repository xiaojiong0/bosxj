            ...
            <form id="loginform" name="loginform" method="post" class="niceform"
                ...
                <div class="loginFormIpt loginFormIptWiotTh"
                    ...
                    <div id="codeInputLine" class="loginFormIpt showPlaceholder"
                        ...
                        <img id="loginform:vCode" src="${pageContext.request.contextPath }/public/validatecode.jsp"
                             onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/public/validatecode.jsp?'+Math.random();" />
                    </div>
...
<div style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: 220px;">
    <span style="color: #5ad56c;">Powered By www.itcast.cn</span><span
        style="color: #488ED5;margin-left:10px;">推荐浏览器（右键链接-目标另存为）：
